...
- 価格、販売エリアと対象国、ショップ表示、AI/写真使用、ライセンス証明、プレミアム参加の希望
...
4. 個数、日英メタ、価格、販売エリア/対象国、手動販売開始、ショップ表示、AI/写真使用、ライセンス証明、プレミアム参加をサマリして停止する。ユーザー本人が同意事項を読み「同意します」を選び、審査をリクエストする
